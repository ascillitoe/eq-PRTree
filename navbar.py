        ...
        [
            ...
            dbc.Nav(
                [
                    ...
                    dbc.NavItem(dbc.NavLink("Supervised Learning", href="/supervised", active='exact',className='px-3')),
                    dbc.NavItem(dbc.NavLink("Polynomial Chaos", href="/pce", active='exact',className='px-3')),
